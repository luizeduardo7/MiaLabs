...
// left wall
const cs = new THREE.TextureLoader().load( 'public/csgo.jpg' );
...
// right wall
const medal = new THREE.TextureLoader().load( 'public/medal.jpg' );
...
audioLoader.load( 'public/shoot.ogg', function( buffer ) {
